document.addEventListener('DOMContentLoaded', function() {
    ...
    // This scroll handler is now replaced by the throttled version above
    ...
    function toggleMobileMenu() {
        ...
        if (isOpen) {
            ...
            hamburger.innerHTML = '✕';
            hamburger.style.backgroundColor = 'rgba(255, 149, 0, 0.1)';
        }
    }
    ...
    const lazyImages = document.querySelectorAll('.menu-item-image, .podium-img, .chef-image');
